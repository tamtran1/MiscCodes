	...
	print ("<div class = \"userBaseFramePanel\">");
		...
		print ("<div class = \"userBasePanel\">");
			...
			print("<div id = \"userExtenPanel\" class = \"userExtenPanel\">");
				...
				print ("<a href = \"javascript: changeAvatar('userExtenPanel');\"><img id = \"userAvatar\" class = \"userAvatar\" src = \"/planes_for_hire/picsUploads/".$avatar."\"></a><br>");
				print ("<a href = \"javascript: changeAvatar('userExtenPanel');\">Change Profile Picture</a><br>");
			print ("</div>");
